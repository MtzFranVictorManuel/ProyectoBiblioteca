...
public class ModificarMultimediaController implements Initializable {
    ...
    Multimedia multimediaInfo = multimedidao.seleccionarMultimedia(Documental.getIdRecursoDocumentalGuarda());
    Documental documentoInfo = documentaldao.selectModificarRecursoDocumental(Documental.getIdRecursoDocumentalGuarda());
        ...
        try{
            ...
            if(Integer.valueOf(textFielNumeroCopias.getText()) <= 0 || textFieldDuraionSegundos.getText().equals("00") || textFieldDuraionSegundos.getText().isEmpty() || textFieldDuraionMinutos.getText().isEmpty()
                ...
                if(datosCorrectos(true) == true){
                    idRecursoDocumental = Documental.getIdRecursoDocumentalGuarda();
