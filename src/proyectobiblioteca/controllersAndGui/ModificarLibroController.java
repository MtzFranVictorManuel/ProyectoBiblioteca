...
public class ModificarLibroController implements Initializable {
    ...
    Documental recursoDocumentalInf = documentaldao.selectModificarRecursoDocumental(Documental.getIdRecursoDocumentalGuarda());
    Libro libroInf = librodao.seleccionarLibro(Documental.getIdRecursoDocumentalGuarda());
